...
include './includes/obtener_detalles_requerimientos.php';
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 ms-sm-auto main-content p-0">
                ...
                <div class="container-fluid p-4">
                    <a href="includes/descargar_ficha_requerimientos_csv.php?id_proyecto=<?php echo $id_proyecto; ?>" class="btn btn-outline-success mb-4">
