...
?>
    ...
    <body>
        ...
        <h2>Justificación</h2>
        <div class="card">
            <div class="info-item"><span class="info-label">Problema:</span><br><?= nl2br($data['descripcion_problema']) ?></div>
            <div class="info-item"><span class="info-label">Oportunidad Identificada:</span><br><?= nl2br($data['oportunidad']) ?></div>
            <div class="info-item"><span class="info-label">Impacto Anticipado:</span><br><?= nl2br($data['impacto_esperado']) ?></div>
        </div>

        <!-- Recursos y Requerimientos -->
        <h2>Recursos y Requerimientos</h2>
        <div class="card">
            ...
            <div class="info-item"><span class="info-label">Recursos Humanos:</span><br><?= nl2br($data['recursos_humanos']) ?></div>
...
<?php
    ...
    // Configurar Dompdf con opciones mejoradas
    $options = new Options();
