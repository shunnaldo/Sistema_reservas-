...
require_once 'phpDaf/get_detalle_ficha.php'; // Este archivo contiene la consulta SQL y llena $data
                ...
                <div class="container-fluid">
                    <div class="row mb-4">
                        <div class="col-12">
                            ...
                            <a href="../Comunicaciones/includes/descargar_detalle_ficha.php?id_proyecto=<?= $id_proyecto ?>" class="btn btn-outline-success mb-4">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <p class="form-control-plaintext"><?= htmlspecialchars($data['nombre_proyecto']) ?></p>
                                </div>

                                <div class="col-md-6">
                                    <label class="data-label required-field">Fecha de Presentación</label>
                                    <p class="form-control-plaintext"><?= htmlspecialchars($data['fecha_presentacion']) ?></p>
                                </div>
                                <div class="col-md-6">
                                    <label class="data-label required-field">Número FIP °</label>
                                    <p class="form-control-plaintext"><?= htmlspecialchars($data['numero_fip']) ?></p>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="form-control-plaintext"><?= htmlspecialchars($data['correo_usuario']) ?></p>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="form-control-plaintext"><?= htmlspecialchars($data['cargo']) ?></p>
                                </div>
                                <div class="col-md-6">
                                    <label class="data-label required-field">Organización</label>
                                    <p class="form-control-plaintext"><?= htmlspecialchars($data['organizacion']) ?></p>
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-12 mt-4">
                                <form action="phpDaf/cambiar_estado.php" method="post" class="d-inline">
